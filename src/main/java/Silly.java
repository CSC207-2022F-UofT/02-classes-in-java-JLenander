...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in a beginning and end string which concatenated forms the name
     *
     * @param beginning The beginning section of the name
     * @param end The end section of the name
     */
